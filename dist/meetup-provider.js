...
function MeetupProvider(options) {
    ...
    function need_event_group_urlname(value, cmd) {
        if (null == value || '' === value) {
            throw new Error('@seneca/meetup-provider: event ' + cmd + ': group_urlname is required');
        }
        return value;
    }
    const entity = {
    ...
    entity.event.cmd.save.action =
        async function save_event(entize, msg) {
